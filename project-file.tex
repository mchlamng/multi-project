...
(hopefully) purchase ice cream for the class and to construct a Riemann sum;
Diego learned how to build the project; and I (Michael) learned too many \LaTeX
\ formatting methods. In the end, the project was fun. We'll just need to find
\emph{something} to do with the final product (maybe Parrie can take it home.)
