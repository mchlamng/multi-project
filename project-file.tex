...
Throughout the project, we all learned different things: Keshav learned how to
(hopefully) purchase ice cream for the class; Diego learned how to build the
project; I (Michael) learned too many \LaTeX \ formatting methods; and Parrie
learned that one can somehow get by on a project without contributing. In the
end, the project was fun. We'll just need to find \emph{something} to do with
the final product. (Maybe Parrie can take it home.)
